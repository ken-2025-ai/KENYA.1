          ...
          <div className="max-w-4xl mx-auto text-primary-foreground">
            ...
            <div className="flex flex-col gap-4 justify-center max-w-md mx-auto md:max-w-none md:flex-row">
              ...
              <Button
                variant="outline"
                size={isMobile ? "default" : "lg"}
                className="w-full md:w-auto bg-white/15 backdrop-blur-sm border-white/30 text-primary-foreground hover:bg-white/25 font-bold hover:scale-105 transition-all duration-300"
