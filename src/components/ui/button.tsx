  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-glow-primary transform hover:scale-105 transition-bounce font-semibold",
        accent: "bg-gradient-accent text-accent-foreground hover:shadow-glow-accent transform hover:scale-105 transition-bounce font-semibold",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-soft hover:shadow-medium",
        premium: "bg-gradient-primary text-primary-foreground border-2 border-primary-glow hover:shadow-glow-primary transform hover:scale-105 transition-bounce font-bold"
      },
      size: {
